<h1>efrain5936</h1>
<a href="https://instagram.com/efrain_5936">My instagram</a>
    <script type="text/javascript">   
		...
		function chatRoom(){
			...
			var str = "";
			if(TalkWords.value == ""){
				 // emergente cuando el mensaje está vacío
			...
			// Unir el contenido anterior con el contenido a enviar Enviar
